...
data_path='/home/shashank/Documents/enkf_for_clv2/data/L96_{}_seed_{}/Sensitivity/PA'.format(model_dim,seed_num)
...
for i,size in enumerate(mss1):
    plt.plot([], [], c='k', alpha=0.6,lw=2,linestyle=line_types[i],marker='.',markersize=size,label=r'$\sigma={}$'.format(sigmas[i]))
...
plt.savefig('blv_principals_3_point_summary_angle_sensitivity_L96-{}_noisy_subspaces_{}.pdf'.format(model_dim,subspace_num),dpi=300)
