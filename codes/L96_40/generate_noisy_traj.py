...
data_path='/mnt/d/PhD Work/enkf_for_clv2/data/L96_{}_seed_{}'.format(model_dim,seed_num)
os.chdir(data_path)

true_traj=np.load('Multiple_trajectories_N=1_gap={}_ti=0.0_tf={}_dt_{}_dt_solver={}.npy'.format(dt,1000.0,dt,dt_solver))
...
os.mkdir('Sensitivity3')
os.chdir('Sensitivity3')
