...
plots_path='/home/shashank/Documents/enkf_for_clv2/plots/L96_10'
...
plt.xlabel(r'$i^{th}$ BLV',fontsize=25)
plt.ylim(0,90)
#plt.yticks(np.arange(0.3,1.1,0.1))
plt.xticks(np.arange(1,num_clv+1,2),fontsize=25)
plt.ylabel(r'Relative angle w.r.t true BLV$(\theta)$',fontsize=25)
...
os.chdir(plots_path)
plt.savefig('blv_angle_sensitivity_L96-{}_seed_{}.pdf'.format(model_dim,seed_num),dpi=300)
