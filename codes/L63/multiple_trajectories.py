...
data_path='/home/shashank/Documents/enkf_for_clv2/data/{}'.format(L63.__name__)

os.chdir(data_path)

#X_o=np.expand_dims(np.load('Initial_condition_on_att_{}.npy'.format(L63.__name__)),axis=1)
...
ax.plot(Trajs[:,0,0],Trajs[:,1,0],Trajs[:,2,0],c='grey',lw=1)
ax.plot(Trajs[:,0,0],Trajs[:,1,0],Trajs[:,2,1],c='grey',lw=2)

ax.plot(Trajs[:,0,0],Trajs[:,1,0],Trajs[:,2,2],c='grey',lw=3)
