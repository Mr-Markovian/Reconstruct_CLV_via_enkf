...
data_path='/home/shashank/Documents/enkf_for_clv2/data/Rossler'
os.chdir(data_path)

#os.chdir('L63_BLV_test1')
#base_traj=np.load('state_noisy_g={}_sigma={}.npy'.format(dt,sigma))
base_traj=np.load('Multiple_trajectories_N=1_gap={}_ti=0.0_tf=1000.0_dt_{}_dt_solver={}.npy'.format(dt,dt,dt_solver))
...
n2=50000   # number of time steps in the interval
