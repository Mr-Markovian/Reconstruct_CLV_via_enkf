...
ax.set_xlabel(r'$X\to$',fontsize=25)
ax.set_ylabel(r'$Y\to$',fontsize=25)
ax.set_zlabel(r'$Z\to$',fontsize=25)
#ax.set_zticks([10,20,30,40])
#ax.text(0,0,40,r'truth'.format(sigma),fontsize=20)
ax.text(0,0,40,r'$\langle C_1, C_3 \rangle$'.format(sigma),fontsize=30)
...
#plt.legend()
#plt.tight_layout()
plt.savefig('enhanced_L63_0.18_attr_01_sigma={}_spacing={}.pdf'.format(sigma,dt*qrstep),dpi=500, bbox_inches='tight', pad_inches=0)
plt.show()
