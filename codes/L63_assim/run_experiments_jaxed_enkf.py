...
parameters['num_assimilations']=35000   # to cover total time=650
...
def forecast(last_analysis_ensemble):
    ...
    return forecast_ensemblealculation
...
k=5
data_path='/home/shashank/Documents/enkf_for_clv2/data/L63_assim'.format(model_dim)
os.chdir(data_path)alculation
...
for mu in mus:
    ...
    observations=np.load('ob{}_gap_0.01_H1__mu={}_obs_cov1.npy'.format(k,mu))
